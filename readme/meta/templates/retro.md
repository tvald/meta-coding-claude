...
<!-- 1–3 bullets of fact, not judgment. -->

## Gap

<!-- The single most important divergence between expected and actual. If none: write "none",
     stop here, done. -->

## Change made

<!-- The concrete edit applied in response — a doc changed, a standard added, a loop adjusted.
     "Awareness" is not a change. Every non-empty Gap must produce either a change or an explicit
     "accepted: not worth fixing because <reason>". Log framework edits in
     readme/log/framework-changelog.md. -->
