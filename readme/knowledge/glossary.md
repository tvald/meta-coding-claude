...
- **order** — a confirmed purchase; a cart becomes an order only after payment succeeds.
  Code: `Order` entity. Not to be confused with **cart**.
-->

*No terms yet. The ingestion loop populates this.*
